      ...
      <div className="flex min-h-dvh flex-col bg-paper">
        ...
        <section className="border-t border-navy/10 bg-paper">
          <div className="mx-auto max-w-[1080px] px-5 py-14 md:px-10 md:py-16">
            <div className="overflow-hidden rounded-sm border border-brick/30 bg-cream-deep">
              <div className="grid gap-6 p-8 md:grid-cols-[1fr_auto] md:items-center md:p-10">
                <div>
                  <div className="flex items-center gap-3">
                    <span className="flex h-9 w-9 items-center justify-center rounded-pill border-2 border-brick bg-paper text-brick">
                      <ShieldAlert size={16} strokeWidth={2.5} />
                    </span>
                    <Eyebrow>Storm Damage · Insurance Claim</Eyebrow>
                  </div>
                  <h2 className="mt-4 font-display text-[26px] font-bold uppercase leading-[1.05] tracking-[0.01em] text-navy md:text-[34px]">
                    Fence Hit By A Storm? <span className="text-brick">We Handle The Claim.</span>
                  </h2>
                  <p className="mt-4 max-w-[58ch] font-body text-[15px] leading-[1.55] text-char">
                ...
                <div className="flex flex-col gap-3 md:items-end">
                  <a
                    href={`${PHONE_HREF}`}
                    className={cn(
                      "inline-flex h-14 items-center justify-center gap-2 rounded-sm bg-brick px-6",
                      "font-display text-[14px] font-semibold uppercase tracking-eyebrow text-cream",
                      "shadow-cta transition-colors hover:bg-brick-deep"
                    )}
                  >
                    <Phone size={14} strokeWidth={2.5} />
                    Call Storm Line · {BUSINESS.phone}
                  </a>
                  <a
                    ...
                    className="inline-flex h-12 items-center justify-center gap-2 rounded-sm border border-navy/30 px-5 font-display text-[13px] font-semibold uppercase tracking-eyebrow text-navy transition-colors hover:border-navy hover:bg-navy/5"
                  >
                    <Mail size={14} strokeWidth={2.5} />
                    Email The Storm Desk
                  </a>
